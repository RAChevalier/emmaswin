<?php
	...
	$result_string = "<table id='resulttable'><tr><td><h4><a href='https://www.google.com.au/search?q=" . @$content . "' title='Click to view results in Google' target='_blank'>Google's Result</a></h4>";
