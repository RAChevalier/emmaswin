<?php
	...
	if (isset($_GET["userid"])) {
		...
		$all_queries = "(SELECT queryid, userid, time, content, location, audio, image, answer FROM $query_table ORDER BY time DESC LIMIT 20) ORDER BY time ASC;";
